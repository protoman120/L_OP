...
EOF
        ...
        if [[ $STORAGE_PARTITION_MOUNTPOINT == "[SWAP]" ]]; then
            ...
            if [[ $STORAGE_SWAP_PARTITION_FOUND == "false" ]]; then
                 ...
                 cat > "$SAVED_SWAP_STORAGE_DATA" <<EOF
                    STORAGE_SWAP_DEVICE="$STORAGE_DEVICE"
                    STORAGE_SWAP_DEVICE_PATH="$STORAGE_DEVICE_PATH"
                    STORAGE_SWAP_DEVICE_MODEL="$STORAGE_DEVICE_MODEL"
                    STORAGE_SWAP_DEVICE_ID_BUS="$STORAGE_DEVICE_ID_BUS"
                    STORAGE_SWAP_DEVICE_BUS="$STORAGE_DEVICE_BUS"
                    STORAGE_SWAP_DEVICE_TYPE="$STORAGE_DEVICE_TYPE"
                    STORAGE_SWAP_DEVICE_ROTATIONAL="$STORAGE_DEVICE_ROTATIONAL"

                    STORAGE_SWAP_PARTITION="$STORAGE_PARTITION"
                    STORAGE_SWAP_PARTITION_PATH="$STORAGE_PARTITION_PATH"
                    STORAGE_SWAP_PARTITION_PARENT_DEVICE="$STORAGE_PARTITION_PARENT_DEVICE"
                    STORAGE_SWAP_PARTITION_FILESYSTEM="$STORAGE_PARTITION_FILESYSTEM"
                    STORAGE_SWAPROOT_PARTITION_MOUNTPOINT="$STORAGE_PARTITION_MOUNTPOINT"
                    STORAGE_SWAP_PARTITION_SIZE="$STORAGE_PARTITION_SIZE"
                    STORAGE_SWAP_PARTITION_UUID="$STORAGE_PARTITION_UUID"
                    STORAGE_SWAP_PARTITION_PARTUUID="$STORAGE_PARTITION_PARTUUID"
                    STORAGE_SWAP_PARTITION_LABEL="$STORAGE_PARTITION_LABEL"

                    STORAGE_SWAP_PARTITION_MOUNT_OPTIONS="$STORAGE_PARTITION_MOUNT_OPTIONS"
                    STORAGE_SWAP_PARTITION_READ_ONLY="$STORAGE_PARTITION_READ_ONLY"
                    STORAGE_SWAP_PARTITION_SWAP="$STORAGE_PARTITION_SWAP"
                    STORAGE_SWAP_PARTITION_EFI="$STORAGE_PARTITION_EFI"
                    STORAGE_SWAP_PARTITION_LUKS="$STORAGE_PARTITION_LUKS"
                    STORAGE_SWAP_PARTITION_BTRFS="$STORAGE_PARTITION_BTRFS"

                    SYSTEM_SWAP_PARTITION_DETECTED="true"
EOF
                    STORAGE_SWAP_PARTITION_FOUND="true"
            fi
        fi
