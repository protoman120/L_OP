...
gpu_save_data(){
    ...
    cat > $SAVED_GPU_DATA_CARD/$SAVED_GPU_DATA_FILE_NAME <<EOF
        GPU_DRM_CARD="$GPU_DRM_CARD"
        GPU_DRM_PATH="$GPU_DRM_PATH"
        GPU_PCI_BDF="$GPU_PCI_BDF"
        GPU_PCI_PATH="$GPU_PCI_PATH"
        GPU_VENDOR="$GPU_VENDOR"
        GPU_TYPE="$GPU_TYPE"
        GPU_CLASS="$GPU_CLASS"
        GPU_DRIVER="$GPU_DRIVER"
        GPU_BOOT_VGA="$GPU_BOOT_VGA"
        GPU_PCIE_LINK_SPEED="$GPU_PCIE_LINK_SPEED"
        GPU_PCE_LINK_WIDTH="$GPU_PCIE_LINK_WIDTH"
        GPU_PCIE_MAX_SPEED="$GPU_PCIE_MAX_SPEED"
        GPU_PCIE_MAX_WIDTH="$GPU_PCIE_MAX_WIDTH"
        GPU_VRAM="$GPU_VRAM"
        GPU_POWER_DRAW="$GPU_POWER_DRAW"
        GPU_POWER_LIMIT="$GPU_POWER_LIMIT"
        GPU_POWER_MIN_LIMIT="$GPU_POWER_MIN_LIMIT"
        GPU_POWER_MAX_LIMIT="$GPU_POWER_MAX_LIMIT"
        GPU_POWER_AVERAGE="$GPU_POWER_AVERAGE"
        GPU_POWER_AVERAGE_W="$GPU_POWER_AVERAGE_W"
        GPU_POWER_CAP="$GPU_POWER_CAP"
        GPU_POWER_CAP_W="$GPU_POWER_CAP_W"

    #INTEL ONLY:
        GPU_FREQ_MIN="$GPU_FREQ_MIN"
        GPU_FREQ_MAX="$GPU_FREQ_MAX"
        GPU_FREQ_CUR="$GPU_FREQ_CUR"
    ...
    #NVIDIA ONLY:
        ...
        GPU_MAX_GRAPHICS_CLOCK="$GPU_MAX_GRAPHICS_CLOCK"
        GPU_MAX_MEMORY_CLOCK="$GPU_MAX_MEMORY_CLOCK"
EOF
